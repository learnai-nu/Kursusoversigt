...
- I skal i gang **i dag** uden budgetgodkendelse
- Målet er fundament (hvad kan LLM’er / hvad kan de ikke)
...
- [Building Effective Human Agent Teams](/ai-kurser/claude-human-agent-teams) — fra single-player til multiplayer AI

Udbyderside: [Claude Academy](/udbydere/claude-academy).
...
- [AI Power-Ups for Google Workspace](/ai-kurser/google-ai-powerups-workspace) — kort Gemini/Workspace-fokus

**Videre**

- [Google AI Professional Certificate](/ai-kurser/google-ai-professional-certificate) — tjek aktuelle vilkår/pris
- [Introduction to Large Language Models](/ai-kurser/google-intro-llms)
- [Build AI Agents with Google](/ai-kurser/google-build-ai-agents)

Udbyderside: [Google Learn AI Skills](/udbydere/google-ai-skills).

## Gratis academy vs. betalt dansk kursus
